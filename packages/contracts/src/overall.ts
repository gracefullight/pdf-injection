 ...
 *
 * Note: for unicode_tags, hiddenTextExtracted is treated exactly like
 * render_mode_3 — RECORDED (contributes to PASS_WITH_WARNINGS when false)
 * but NEVER part of the FAIL condition. Extraction success from a real
